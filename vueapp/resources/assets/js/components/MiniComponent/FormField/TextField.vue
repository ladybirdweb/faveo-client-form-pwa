<template>
    ...
    <form-field-template :label="label" :labelStyle="labelStyle" :name="name" :classname="classname" :hint="hint" :required="required"
                         :isInlineForm="isInlineForm" :actionBtn="actionBtn" :tipRule="tipRule">
        ...
        <template v-if="from">
           ...
           <div v-if="type === 'textarea'">
              ...
              <textarea :id="id" :name="name" :class="['form-control', inputClass]" :maxlength="length" :type="type" v-model="changedValue"
                v-on:input="onChange(changedValue, name)" :cols="columns" :rows="rows" :style="inputStyle" :pattern="pattern ? pattern : null" 
          ...
          <input v-else :id="id" :name="name" :class="['form-control', inputClass]" :type="type" :disabled="disabled" :style="inputStyle" 
            ...
            @keydown="keydownListener($event,name)" @keypress="keypressEvt($event,name)" @paste="pasteEvt($event,name)"
            :placeholder="placehold" :maxlength="max ? max : undefined" :pattern="pattern ? pattern : null"
          />
      </template>
